...
/**
 * Description: MapReduce job to get the Total net Generation of electricity 
 * @author GROUP 1
 *
 */
public class TotalGeneration {
	...
	public static class mapper extends Mapper<Object, Text ,IntWritable, DoubleWritable>{
		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			/**storing in year, generation and electricity */
			int year = Integer.parseInt(oneArray[1]);
			Double generation = Double.parseDouble(oneArray[3]);
			Double imported = Double.parseDouble(oneArray[4]);
			Double netGeneration = generation + imported ;
			
				IntWritable keyto = new IntWritable(year); 
				context.write(keyto,new DoubleWritable(netGeneration));
	...
	public static void main(String[] args) throws Exception {
		...
		jobs.setJarByClass(TotalGeneration.class);
